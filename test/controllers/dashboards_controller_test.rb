...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference("Dashboard.count") do
      post dashboards_url, params: { dashboard: { description: @dashboard.description, name: @dashboard.name } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { description: @dashboard.description, name: @dashboard.name } }
